...
const Dashboard = (props) => {
  const url = sample();
  return <iframe src={url} height="700" width="1000"></iframe>;
};
...
function created_signed_embed_url(options) {
  ...
  const signature = Hmac.createHmac("sha1", secret)
...
function sample() {
  ...
  const url_data = {
    ...
    // },
    user_attributes: {
      an_attribute_name: "my_attribute_value",
      school_id: "1234",
    },
    session_length: fifteen_minutes,
    embed_url: "/embed/dashboards/5",
